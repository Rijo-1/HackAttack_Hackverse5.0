...
import { calculateCarbonFootprint, calculateGreennessScore } from '../../utils/trading/carbonFootprint';
...
interface TradingInterfaceProps {
  ...
  onClosePosition: (playerName: string, positionIndex: number) => void;
  gameEnded: boolean;
  currentPrice?: number;
}
        ...
        <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/20">
          ...
          <div className="space-y-2">
            {player.positions.map((position, index) => {
              ...
              const carbonFootprint = calculateCarbonFootprint(position.amount, position.leverage);
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-400">
                          <span className="mr-2">Carbon Footprint: {carbonFootprint.toFixed(2)}g CO2</span>
                          <span className={`${greennessScore > 70 ? 'text-green-500' :
                            greennessScore > 40 ? 'text-yellow-500' :
                              'text-red-500'
                            }`}>
                            {greennessScore}% Green
                          </span>
                        </div>
                      </div>
                    </div>
      ...
      <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-500/20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <div className={`w-full bg-black/20 border rounded-lg px-4 py-2 text-white ${isMarginExceedingBalance ? 'border-red-500' : 'border-purple-500/20'
              }`}>
              ${margin.toFixed(2)}
